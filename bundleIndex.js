...
axios.get("https://407344f8.ngrok.io").then((resp)=>{
    let data=resp.data;
    Object.keys(data).map((key, index)=>{
        let aux = index +1;
        document.getElementById("t"+aux+"t").innerHTML="x"+data[key].TacoCont.Triste;
        document.getElementById('t'+aux+'n').innerHTML="x"+data[key].TacoCont.Normal;
        document.getElementById('t'+aux+'f').innerHTML="x"+data[key].TacoCont.Feliz;
